...
const AddBook = ({ onSubmit }) => {
  ...
  const handleChange = (e) => {
    ...
    setNewBook((prev) => ({
      ...prev,
      id: newBook.id === "" ? Math.floor(Math.random() * 1000) : newBook.id,
      [name]: value,
    }));
  };
  ...
  return (
    <div className={style.head_text}>
      ...
      <div className={style.text_on_image}>
        <div className={style.add_book_title}>
        ...
        <div>
          <form>
            <div className={style.book_form}>
              ...
              <div className={style.book_row}>
                <label className={style.font}>Year</label>
                <input
                  type="text"
                  value={newBook.year}
                  name="year"
              ...
              <div className={style.book_row}>
                <label className={style.font}>Pages</label>
                <input
                  type="text"
                  value={newBook.pages}
                  name="pages"
